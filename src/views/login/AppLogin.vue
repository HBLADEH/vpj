    ...
    <div class="login-box">
      <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-position="left" label-width="0px" class="demo-ruleForm login-container" status-icon>
        ...
        <el-form-item prop="checkPass">
          <el-input :type="passwordType" v-model="ruleForm.checkPass" auto-complete="off" placeholder="密码" id="loginPassword"></el-input>
          <label id="showPasswordToggle">
            <el-checkbox v-model="checked" id="showPasswordCheck" @change="changePass">显示密码</el-checkbox>
          </label>
...
export default {
  ...
  methods: {
     ...
     */
    changePass() {
      this.passwordType = this.checked ?
        "text" : "password"
    },
    handleSubmit(ev) {
